    ...
    public void run(String... args) {
        if (prendaRepository.count() == 0) {
            List<Prenda> prendas = List.of(
                    ...
                    new Prenda(null, "conjunto dama", 13000.0, null),
                    ...
                    new Prenda(null, "bolso dama", 13500.0, null),
                    ...
                    new Prenda(null, "duvet", 13000.0, null),
                    new Prenda(null, "sabana", 8000.0, null),
                    new Prenda(null, "funda", 3500.0, null),
                    ...
                    new Prenda(null, "faldon prensado", 25000.0, null),
                    new Prenda(null, "toalla", 6500.0, null),
                    new Prenda(null, "cortina", 5300.0, null),
                    new Prenda(null, "tapete", 12000.0, null),
                    new Prenda(null, "muñeco", 70000.0, null),
                    new Prenda(null, "vestido", 12000.0, null),
                    new Prenda(null, "tintura", 18500.0, null),
                    new Prenda(null, "forros de carro", 6500.0, null),
                    new Prenda(null, "boxer", 3000.0, null),
                    new Prenda(null, "medias", 3000.0, null),
                    ...
                    new Prenda(null, "chaquetas de moto", 8500.0, null),
                    new Prenda(null, "protector de colchon", 18000.0, null),
                    new Prenda(null, "licra", 15000.0, null),
                    new Prenda(null, "bolso", 9000.0, null),
                    new Prenda(null, "correa", 6500.0, null),
                    new Prenda(null, "forro", 10000.0, null),
                    new Prenda(null, "truza", 9000.0, null),
                    new Prenda(null, "vestido de baño", 12000.0, null),
                    new Prenda(null, "brasier", 7000.0, null),
                    new Prenda(null, "camuflado", 40000.0, null),
                    new Prenda(null, "edredon", 15000.0, null),
                    new Prenda(null, "capota", 6000.0, null),
                    new Prenda(null, "top", 15000.0, null),
                    new Prenda(null, "esqueleto", 7000.0, null),
                    new Prenda(null, "enagua", 12000.0, null),
                    new Prenda(null, "faja", 15000.0, null),
                    new Prenda(null, "kimono", 18000.0, null),
                    new Prenda(null, "pantaloneta", 12000.0, null),
                    new Prenda(null, "body", 12000.0, null),
