...
import PedidoCreado from "../../../assets/sounds/pedidoCreado.mp3";

/* Importar imágenes */
const images = import.meta.glob("/src/assets/img/prendas/*.png", {
  eager: true,
});
 
const getImage = (nombre) => {
  const fileName = nombre + ".png";
  const path = `/src/assets/img/prendas/${fileName}`;
          ...
          <div className="cont-prendas">
            {prendas.map((prenda) => (
              <CardPrenda
                ...
                imgPrenda={getImage(prenda.descripcion)}
