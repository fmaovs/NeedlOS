...
public enum TipoPrenda {
    ...
    BERMUDA_2(51, "Bermuda", 10000),
    SHORT(52, "Short", 6500),
    CHAQUETAS_DE_MOTO(53, "Chaquetas De Moto", 8500),
    PROTECTOR_DE_COLCHON(54, "Protector De Colchon", 18000),
    LICRA(55, "Licra", 15000),
    BOLSO(56, "Bolso", 9000),
    CORREA(57, "Correa", 6500),
    FORRO(58, "Forro", 10000),
    TRUZA(59, "Truza", 9000),
    VESTIDO_DE_BAÑO(60, "Vestido De Baño", 12000),
    BRASIER(61, "Brasier", 7000),
    CAMUFLADO(62, "Camuflado", 40000),
    EDREDON(63, "Edredon", 15000),
    CAPOTA(64, "Capota", 6000),
    TOP(65, "Top", 15000),
    ESQUELETO(66, "Esqueleto", 7000),
    ENAGUA(67, "Enagua", 12000),
    FAJA(68, "Faja", 15000),
